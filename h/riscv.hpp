...
{
public:
    static void printHexa(uint64 xx);
    static uint64 r_a1();
    static uint64 r_a0();
    static uint64 r_a2();
    static uint64 r_a3();
    ...
    static void w_a0(int ret);

    // pop sstatus.spp and sstatus.spie bits (has to be a non inline function)
    static void popSppSpie();
    //ne sme da bude inline jer se ne ugradju vec se poziva direktno masinskom
    //instrukcijom jer menja stanje procesora
...
{
    uint64 volatile ar;
    __asm__ volatile("ld %0,8*14(fp)":"=r"(ar));
    return ar;
}

inline void Riscv::w_a0(int ret)
{
